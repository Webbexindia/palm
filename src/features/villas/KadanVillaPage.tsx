...
export function KadanVillaPage() {
  const [sliderImages, setSliderImages] = React.useState<string[]>([]);

  React.useEffect(() => {
    fetch('/kadanvilla/images.json')
      .then((res) => res.json())
  ...
  return (
    <HelmetProvider>
      <MainLayout>
        <SEO
  title="Kadan Villa | Premium Luxury Villa in Lonavala | Palm Manor"
  description="Discover Kadan Villa at Palm Manor Lonavala, offering spacious interiors, modern comforts, a private swimming pool, and a peaceful retreat for families, friends, and corporate groups."
  keywords="Kadan Villa Lonavala, luxury villa Lonavala, private villa with pool, Palm Manor Kadan Villa, villa for family stay, premium villa resort"
  slug="/villas/kadan"
/>
        ...
        <div 
          ...
          style={{ backgroundImage: 'url("/Kadan-Villa.jpg")' }}
        >
           ...
           <div className="max-w-7xl mx-auto px-6 md:px-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                 ...
                 <div className="space-y-12">
                    ...
                    <div className="bg-brand-black/40 p-8 backdrop-blur-md rounded-sm border border-white/5">
                       ...
                       <p className="text-white/90 italic mb-6 text-lg">
                          Where stillness becomes celebration.
                       </p>
                       <p className="text-brand-ivory/80 leading-relaxed font-light mb-4">
                          Kadan brings together lush outdoor living and an effortless sense of abundance. Its vibrant gardens, generously proportioned spaces, and exclusively private pool make it the ideal home for festive gatherings, milestone celebrations, or simply those moments when you want life to feel a little more expansive. Kadan is warmth made architectural.
                       </p>
                       <p className="text-brand-ivory/90 text-sm mt-6">
                          <span className="font-semibold text-white">Best For:</span> Celebrations · Pre-wedding Functions · Group Getaways
                       </p>
                    </div>
                    ...
                    <div className="bg-brand-black/40 p-8 backdrop-blur-md rounded-sm border border-white/5">
                       ...
                       <ul className="space-y-4">
                          {[
                            ...
                            'Attached En-suite Washrooms',
                            'Spacious Common Hall',
                            'Lounge Sitting Area',
                            'Balcony (Partly Open & Partly Enclosed)',
                            'Terrace with scenic outdoor views'
                          ].map((item, i) => (
                 ...
                 <div className="space-y-12">
                     ...
                     {/* Suitable */}
                     <div className="bg-brand-black/40 p-8 backdrop-blur-md rounded-sm border border-white/5">
                       <h3 className="text-2xl font-serif text-white tracking-widest uppercase mb-6">Suitable For</h3>
                       <ul className="space-y-4">
                          {[
                            'Birthday Parties', 
